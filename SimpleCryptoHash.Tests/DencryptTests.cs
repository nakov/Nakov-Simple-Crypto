...
public class DecryptMsgTests
{
	...
	public void TestDecryptMsg(string encryptedMsg, string password, string originalMsg)
	{
		string decryptedMsg = SimpleCrypto.DecryptMsg(encryptedMsg, password);
		Assert.That(decryptedMsg, Is.EqualTo(originalMsg));
	}

	public void TestDecryptMsgInvalidPassword()
	{
		string encryptedMsg = "546DBAB0DE8B849D70DA";
		string password = "invalid password";
		string originalMsg = "Msg";
		string decryptedMsg = SimpleCrypto.DecryptMsg(encryptedMsg, password);
		Assert.That(decryptedMsg, Is.Not.EqualTo(originalMsg));
	}
}
